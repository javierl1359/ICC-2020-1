...
public class SVG {
    ...
    public void agregarTriangulo(Triangulo triangulo) {
      String s = "< line x1=\""+ triangulo.geta().getX()+" y1=\""+triangulo.geta().getY()+" x2=\""+ triangulo.getb().getX()+" y2=\""+triangulo.getb().getY()+"\" style=\"stroke: black; stroke = width: 1\"/>";
        String t = "< line x1=\""+ triangulo.geta().getX()+" y1=\""+triangulo.geta().getY()+" x3=\""+ triangulo.getc().getX()+" y3=\""+triangulo.getc().getY()+"\" style=\"stroke: black; stroke = width: 1\"/>";
          String u = "< line x2=\""+ triangulo.getb().getX()+" y2=\""+triangulo.getb().getY()+" x3=\""+ triangulo.getc().getX()+" y3=\""+triangulo.getc().getY()+"\" style=\"stroke: black; stroke = width: 1\"/>";
          concatenar(s+t+u);
    }
